...
job_description ="""Reconcile invoices and identify discrepancies. Create and update expense reports.Process reimbursement forms.
...
combined_texts = resumes_with_id["Cleaned_Resume"].tolist() + [job_description]
#%%
...
resumes_vec = vectorized_texts[:len(resumes_with_id)]
job_desc_vec = vectorized_texts[len(resumes_with_id):]
